...
public class UserController {
	...
	public ResponseEntity<?> addUsers(@RequestBody User user) {
		try {
			...
			return new ResponseEntity<>("Error al agregar Usuario" + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<?> updateUser(@RequestBody User user) {
		try {
			...
			return new ResponseEntity<>("Error al modificar Usuario" + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
